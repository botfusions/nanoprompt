...
export default function CategoryPageClient({
  ...
  const remaining = initialTotal - prompts.length;
    ...
    <main className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-brand-black/60">{initialTotal} prompt bulundu</p>
        </div>
        ...
        {prompts.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <Link href="/" className="text-brand-cyan font-bold hover:underline">
              Tum promptlara don
            </Link>
          </div>
        )}
