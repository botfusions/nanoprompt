  ...
  return (
    <header className="bg-brand-cyan border-b-4 border-brand-black py-8 md:py-12 px-4 mb-8 md:mb-12 relative overflow-hidden w-full">
      ...
      <div className="container mx-auto flex justify-between items-center relative z-20 mb-8 md:mb-12">
        <Link
          href="/"
          className="bg-white border-2 border-brand-black px-4 py-2 shadow-neo font-black text-xl tracking-tighter hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none transition-all rounded-none uppercase flex items-center gap-2"
        >
          BotsNANO
      ...
      <div className="absolute right-4 md:right-12 top-1/2 -translate-y-1/2 z-20 hidden md:block">
        <div
          className="bg-yellow-200 w-48 p-4 shadow-lg transform rotate-3 hover:rotate-0 transition-transform duration-300"
          style={{
        ...
        >
          ...
          <p
            className="text-amber-800 font-handwriting text-sm leading-relaxed"
            style={{ fontFamily: "cursive" }}
          >
            📌 Promptlar
            <br />
            <span className="font-bold">nanobanan ve gpt image 2.0</span>
            <br />
            için
          </p>
        </div>
